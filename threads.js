...
class Threads {
   ...
   */
  constructor(threadNum, baseArgs, fnArray, finalCb = () => {}, finalCbArgs = []) {
     ...
     * @property {Function} [fnFail] - The catch function to be executed when the main function fails.
     * @property {Function} [fnCbFail] - The catch function to be executed when the callback function fails.
     */
    this.fnArray = fnArray;

    /** Final callback funtion that runs when all the function calls have been completed. */
    this.finalCb = finalCb;

    /** An argument passed to the finalCb */
    this.finalCbArgs = finalCbArgs;
